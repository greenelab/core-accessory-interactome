...
# # Decide threshold
#
# This notebook will use the distribution of accessory gene expression to determine the threshold to use in [1_create_compendia.ipynb](1_create_compendia.ipynb) to partition gene expression data into PAO1 and PA14 compendia.
#
# This notebook need only be run once to determine the threshold

...
# + magic_args="-s $paths.PAO1_REF $paths.PAO1_DB_DIR" language="bash"
#
# makeblastdb -in $1 -dbtype nucl -parse_seqids -out $2

# + magic_args="-s $paths.PA14_REF $paths.PA14_DB_DIR" language="bash"
#
# makeblastdb -in $1 -dbtype nucl -parse_seqids -out $2
# -
...
# + magic_args="-s $paths.PHAGE_REF $paths.PAO1_BLAST_RESULT $paths.PAO1_DB_DIR" language="bash"
# blastn -query $1 -out $2 -db $3 -outfmt 6

# + magic_args="-s $paths.PHAGE_REF $paths.PA14_BLAST_RESULT $paths.PA14_DB_DIR" language="bash"
# blastn -query $1 -out $2 -db $3 -outfmt 6
# -

...
expression_pao1_phage_df = pd.read_csv(
    paths.PAO1_PHAGE_GE, sep="\t", index_col=0, header=0
)
expression_pa14_phage_df = pd.read_csv(
    paths.PA14_PHAGE_GE, sep="\t", index_col=0, header=0
)
...
print(
    "Percent of 0 expressed genes:",
    (expression_pao1_phage_df.loc["SRR13234437"] == 0).sum()
    / len(expression_pao1_phage_df.loc["SRR13234437"]),
)

# +
EColi_pao1_phage_ref_series = expression_pao1_phage_df.loc["SRR13234437"]
nonzero_genes_EColi_pao1_phage_ref = EColi_pao1_phage_ref_series.iloc[
    EColi_pao1_phage_ref_series.nonzero()
]
...
threshold = 1000
majority_genes_EColi_pao1_phage_ref = nonzero_genes_EColi_pao1_phage_ref[
    nonzero_genes_EColi_pao1_phage_ref < threshold
]

print(
    f"Percent of nonzero genes below {threshold}:",
    (len(majority_genes_EColi_pao1_phage_ref))
    / len(nonzero_genes_EColi_pao1_phage_ref),
)
...
print(
    "Percent of 0 expressed genes:",
    (expression_pa14_phage_df.loc["SRR13234437"] == 0).sum()
    / len(expression_pa14_phage_df.loc["SRR13234437"]),
)

# +
EColi_pa14_phage_ref_series = expression_pa14_phage_df.loc["SRR13234437"]
nonzero_genes_EColi_pa14_phage_ref = EColi_pa14_phage_ref_series.iloc[
    EColi_pa14_phage_ref_series.nonzero()
]
...
# What are the genes outside of this distribution? Why are they outside
threshold = 1000
majority_genes_EColi_pa14_phage_ref = nonzero_genes_EColi_pa14_phage_ref[
    nonzero_genes_EColi_pa14_phage_ref < threshold
]

print(
    f"Percent of nonzero genes below {threshold}:",
    (len(majority_genes_EColi_pa14_phage_ref))
    / len(nonzero_genes_EColi_pa14_phage_ref),
)
...
# Get outlier gene
print(
    nonzero_genes_EColi_pao1_phage_ref[
        nonzero_genes_EColi_pao1_phage_ref == nonzero_genes_EColi_pao1_phage_ref.max()
    ]
)
print(
    nonzero_genes_EColi_pa14_phage_ref[
        nonzero_genes_EColi_pa14_phage_ref == nonzero_genes_EColi_pa14_phage_ref.max()
    ]
)
...
print(
    "Percent of positive-expressed genes:",
    (expression_pao1_phage_df.loc["SRR13160334"] > 0).sum()
    / len(expression_pao1_phage_df.loc["SRR13160334"]),
)

# +
# Plot the expression of PAO1 nonzero genes
pao1_sample_pao1_phage_ref_series = expression_pao1_phage_df.loc["SRR13160334"]
nonzero_genes_pao1_sample_pao1_phage_ref = pao1_sample_pao1_phage_ref_series.iloc[
    pao1_sample_pao1_phage_ref_series.nonzero()
]
...
# What are the genes outside of this distribution? Why are they outside
threshold = 1000
majority_genes_pao1_sample_pao1_phage_ref = nonzero_genes_pao1_sample_pao1_phage_ref[
    nonzero_genes_pao1_sample_pao1_phage_ref < threshold
]

print(
    f"Percent of nonzero genes below {threshold}:",
    (len(majority_genes_pao1_sample_pao1_phage_ref))
    / len(nonzero_genes_pao1_sample_pao1_phage_ref),
)

fig5 = sns.distplot(
    nonzero_genes_pao1_sample_pao1_phage_ref[
        nonzero_genes_pao1_sample_pao1_phage_ref < threshold
    ],
    kde=False,
)
...
print(
    "Percent of positive-expressed genes:",
    (expression_pa14_phage_df.loc["ERR3642743"] > 0).sum()
    / len(expression_pa14_phage_df.loc["ERR3642743"]),
)

# +
# Plot the expression of PAO1 nonzero genes
pa14_sample_pa14_phage_ref_series = expression_pa14_phage_df.loc["ERR3642743"]
nonzero_genes_pa14_sample_pa14_phage_ref = pa14_sample_pa14_phage_ref_series.iloc[
    pa14_sample_pa14_phage_ref_series.nonzero()
]
...
# What are the genes outside of this distribution? Why are they outside
threshold = 1000
majority_genes_pa14_sample_pa14_phage_ref = nonzero_genes_pa14_sample_pa14_phage_ref[
    nonzero_genes_pa14_sample_pa14_phage_ref < threshold
]

print(
    f"Percent of nonzero genes below {threshold}:",
    (len(majority_genes_pa14_sample_pa14_phage_ref))
    / len(nonzero_genes_pa14_sample_pa14_phage_ref),
)

fig5 = sns.distplot(
    nonzero_genes_pa14_sample_pa14_phage_ref[
        nonzero_genes_pa14_sample_pa14_phage_ref < threshold
    ],
    kde=False,
)
